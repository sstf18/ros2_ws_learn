...
class SimpleDiffDrive(Node):
    def __init__(self):
        super().__init__('simple_diff_drive')
        ...
        # initializes the variables to store the current commanded linear velocity(v) and angular velocity (w)
        self.cmd_lin = 0.0  # m/s
        self.cmd_ang = 0.0  # rad/s
        ...
        self.get_logger().info('SimpleDiffDrive node started.')
